...
const EditComplain = ({complain}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await patchDataAPI(`editComplain/${editcomplain._id}`,editcomplain,auth.token);
    ...
    <div className="complainLeftWrapper">
        <ul className="complainList">
           <li className="complainListItem">
              ...
              <input type="text" value={editcomplain?.id} 
              className="complaininfoValue"></input>
           </li>
           <li className="complainListItem">
              <div className="complainInfoKey">Description :</div>
              <input type="text" id="description" name="description" value={editcomplain?.description}
            onChange={handleChange}  className="complaininfoValue"></input>
           </li>
           <li className="complainListItem">
              <div className="complainInfoKey">Customer :</div>
              <input type="text" value={editcomplain?.customer?.name}
               className="complaininfoValue"></input>
           </li>
           <li className="complainListItem">
              <div className="complainInfoKey">Employee responsible :</div>
              <input type="text" id="rsg" name="rsg" value={editcomplain?.rsg}
               className="complaininfoValue"></input>
           </li>
         </ul>
         ...
         <ul className="complainList">
           <li className="complainListItem">
              ...
              <span className=''>
                        <select onChange={handleChange}
                         value={editcomplain["status"] || "new"} name="status" 
           ...
           <li className="complainListItem">
              ...
              <span className=' '>
                        <select onChange={handleChange}
                         value={editcomplain["catagory1"] || "Supply"}  name="catagory1"
                         className='complaininfoValue'>
           ...
           <li className="complainListItem">
              ...
              <span className=' '>
                        <select onChange={handleChange}
                         value={editcomplain["catagory2"] || "No supply"}  name="catagory2"
                         className='complaininfoValue'>
                            <option></option>
                            {editcomplain["catagory1"] === "Supply" &&<>
                             ...
                             <option>Meter change without customer acknowledgment</option>
                             ...
                             <option>Bill not Generated/Balance Brought Forward</option>
                             <option>Estimated Readings</option>
                             <option>Late of Name Transfer / Meter Change details</option>
                             ...
                             <option>Suspection on Corruption of EEU Employee</option>
                             <option>Late Response from EEU Employee</option>
                             <option>Misbehaviours of EEU Employee</option>
                             <option>Unavailability of Manager / Employee in EEU Office</option>
                             ...
                             <option>Estimation Sheet/Cost of Estimation/Demand Note</option>
          ...
          <li className="complainListItem">
              ...
              <input type="text" id="phone" name="phone" value={editcomplain?.phone}
            onChange={handleChange}  className="complaininfoValue"></input>
           </li>
           <li className="complainListItem">
              <div className="complainInfoKey">Address :</div>
              <input type="text" id="address" name="address" value={editcomplain?.address}
            onChange={handleChange}  className="complaininfoValue"></input>
           </li>
         <hr className="complainHr" />
         <ul className="complainList">
           ...
           <li className="complainListItem">
              ...
              <input type="text"  value={editcomplain?.created_by}
                  className="complaininfoValue"></input>
           </li>
         </ul>
         </div>
         <div className="">
            <button type="submit"  className="complainbtn" 
            // disabled={!(editcomplain?.description.trim()) || !(editcomplain?.catagory2.trim()}
            >Save</button>
          </div>
          </form>}

          {!edit && <> <div className="label">
                    ...
                    <div className="label">
                      ...
                      <div className="label-value">{new Date(editcomplain?.createdAt).toLocaleString()} </div>
                    </div>
                    <div className="label">
                    ...
                    <button  className="complainbtn" onClick={() => setEdit(true)}>Edit</button>
                </>}
